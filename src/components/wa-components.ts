...
export const WA_FREE_COMPONENTS: WaComponentDefinition[] = [
  ...
  {
    name: 'button-group',
    importPath: 'button-group/button-group.js',
    label: 'Button Group',
    category: 'Action',
  },
  {
    name: 'copy-button',
    importPath: 'copy-button/copy-button.js',
    label: 'Copy Button',
    category: 'Action',
  },
  ...
  {
    name: 'carousel',
    importPath: 'carousel/carousel.js',
    label: 'Carousel',
    category: 'Containment',
  },
  {
    name: 'carousel-item',
    importPath: 'carousel-item/carousel-item.js',
    label: 'Carousel Item',
    category: 'Containment',
  },
  ...
  {
    name: 'tab-group',
    importPath: 'tab-group/tab-group.js',
    label: 'Tab Group',
    category: 'Containment',
  },
  {
    name: 'tab-panel',
    importPath: 'tab-panel/tab-panel.js',
    label: 'Tab Panel',
    category: 'Containment',
  },
  ...
  {
    name: 'breadcrumb',
    importPath: 'breadcrumb/breadcrumb.js',
    label: 'Breadcrumb',
    category: 'Navigation',
  },
  {
    name: 'breadcrumb-item',
    importPath: 'breadcrumb-item/breadcrumb-item.js',
    label: 'Breadcrumb Item',
    category: 'Navigation',
  },
  {
    name: 'dropdown',
    importPath: 'dropdown/dropdown.js',
    label: 'Dropdown',
    category: 'Navigation',
  },
  {
    name: 'dropdown-item',
    importPath: 'dropdown-item/dropdown-item.js',
    label: 'Dropdown Item',
    category: 'Navigation',
  },
  {
    name: 'split-panel',
    importPath: 'split-panel/split-panel.js',
    label: 'Split Panel',
    category: 'Navigation',
  },
  ...
  {
    name: 'tree-item',
    importPath: 'tree-item/tree-item.js',
    label: 'Tree Item',
    category: 'Navigation',
  },
  ...
  {
    name: 'color-picker',
    importPath: 'color-picker/color-picker.js',
    label: 'Color Picker',
    category: 'Input',
  },
  ...
  {
    name: 'number-input',
    importPath: 'number-input/number-input.js',
    label: 'Number Input',
    category: 'Input',
  },
  ...
  {
    name: 'radio-group',
    importPath: 'radio-group/radio-group.js',
    label: 'Radio Group',
    category: 'Input',
  },
  ...
  {
    name: 'progress-bar',
    importPath: 'progress-bar/progress-bar.js',
    label: 'Progress Bar',
    category: 'Feedback',
  },
  {
    name: 'progress-ring',
    importPath: 'progress-ring/progress-ring.js',
    label: 'Progress Ring',
    category: 'Feedback',
  },
  ...
  {
    name: 'comparison',
    importPath: 'comparison/comparison.js',
    label: 'Comparison',
    category: 'Data Display',
  },
  {
    name: 'format-bytes',
    importPath: 'format-bytes/format-bytes.js',
    label: 'Format Bytes',
    category: 'Data Display',
  },
  {
    name: 'format-date',
    importPath: 'format-date/format-date.js',
    label: 'Format Date',
    category: 'Data Display',
  },
  {
    name: 'format-number',
    importPath: 'format-number/format-number.js',
    label: 'Format Number',
    category: 'Data Display',
  },
  ...
  {
    name: 'relative-time',
    importPath: 'relative-time/relative-time.js',
    label: 'Relative Time',
    category: 'Data Display',
  },
  ...
  { name: 'divider', importPath: 'divider/divider.js', label: 'Divider', category: 'Layout' },
  {
    ...
    importPath: 'resize-observer/resize-observer.js',
  ...
  {
    name: 'animation',
    importPath: 'animation/animation.js',
    label: 'Animation',
    category: 'Utility',
  },
  {
    name: 'animated-image',
    importPath: 'animated-image/animated-image.js',
  ...
  { name: 'include', importPath: 'include/include.js', label: 'Include', category: 'Utility' },
  {
    ...
    importPath: 'intersection-observer/intersection-observer.js',
    label: 'Intersection Observer',
    category: 'Utility',
  },
  {
    name: 'mutation-observer',
    importPath: 'mutation-observer/mutation-observer.js',
  ...
  {
    name: 'zoomable-frame',
    importPath: 'zoomable-frame/zoomable-frame.js',
    label: 'Zoomable Frame',
    category: 'Media',
  },
];
